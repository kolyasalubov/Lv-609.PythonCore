...
# background_image = pygame.image.load("PS.png").convert()
player_image = pygame.image.load(r"C:\Users\Monstro\Desktop\395-3955637_pegatina-breaking-bad-heisenberg-danger-heisenberg-breaking-bad.png").convert()
